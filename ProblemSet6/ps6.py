...
class WordTrigger(Trigger):
    ...
    def isWordIn(self,text):
        new_text = replacePunctuation(text.lower())
        

        if self.word.lower() in new_text:
            return True
        else:
            return False
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self,story):
        ...
        return inTitle or inSubject or inSummary
